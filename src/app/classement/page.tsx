    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-24">
      ...
      <main className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <header className="mb-20 text-center space-y-4">
          <Badge variant="outline" className="bg-white border-primary/20 text-primary px-4 py-1 rounded-full font-bold uppercase tracking-[0.2em] text-[10px]">
            {contestName}
          </Badge>
          <h1 className="font-headline text-5xl md:text-8xl font-bold text-[#0A3D62] uppercase tracking-tighter leading-none">
            Tableau d'Honneur
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end max-w-5xl mx-auto px-4">
            ...
            <div className="order-2 md:order-1">
              <Card className="border-none shadow-xl bg-[#E2E8F0] rounded-[3rem] overflow-hidden text-center h-[380px] flex flex-col justify-center transition-transform hover:scale-[1.02]">
                <CardContent className="pt-8 space-y-4">
                  <div className="w-16 h-16 bg-white/50 rounded-full flex items-center justify-center mx-auto mb-2 shadow-sm">
            ...
            <div className="order-1 md:order-2 scale-105 md:scale-110 z-10">
              <Card className="border-none shadow-2xl bg-[#FF8A50] rounded-[4rem] overflow-hidden text-center h-[480px] flex flex-col justify-center relative border-4 border-white/20">
                ...
                <CardContent className="pt-10 text-white relative z-10 space-y-6">
                  <div className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-2 shadow-inner border-2 border-white/20">
                    <Trophy className="h-12 w-12 text-yellow-300 drop-shadow-md" />
                  </div>
                  <h3 className="font-headline text-3xl font-bold truncate px-4">
                    {top3[0]?.name || "---"}
                  </h3>
                  <div>
            ...
            <div className="order-3">
              <Card className="border-none shadow-xl bg-[#E2E8F0] rounded-[2.5rem] overflow-hidden text-center h-[340px] flex flex-col justify-center transition-transform hover:scale-[1.02]">
                <CardContent className="pt-8 space-y-4">
                  <div className="w-14 h-14 bg-white/50 rounded-full flex items-center justify-center mx-auto mb-2 shadow-sm">
        ...
        <section className="mb-32 max-w-5xl mx-auto px-4">
          <Card className="bg-[#0F172A] text-white border-none rounded-[4rem] shadow-2xl overflow-hidden relative">
            ...
            <CardContent className="p-12 md:p-20 relative z-10">
               <div className="flex items-center gap-6 mb-16">
                 <div className="p-4 bg-yellow-400 rounded-3xl shadow-lg shadow-yellow-400/20">
                   <Star className="h-10 w-10 text-[#0F172A] fill-[#0F172A]" />
                 </div>
                 <div>
                    <h2 className="font-headline text-4xl font-bold italic uppercase leading-tight tracking-tighter">LE RECORD : BIG FISH</h2>
                    <p className="text-slate-500 text-sm font-bold uppercase tracking-widest mt-1">La prise historique du concours</p>
                 </div>
               </div>
               ...
               <div className="grid md:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                     <div className="bg-white/5 backdrop-blur-xl p-8 rounded-[2rem] border border-white/10">
                        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4">ESPÈCE & CHAMPION</p>
                        <div className="flex justify-between items-baseline">
                          <p className="text-3xl font-headline font-bold text-primary">{bigFish?.fishName || "---"}</p>
                          <p className="text-xl font-headline text-white/80">{bigFish?.anglerName || "---"}</p>
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-2 gap-6">
                        <div className="bg-white/5 backdrop-blur-xl p-8 rounded-[2rem] border border-white/10">
                           ...
                           <p className="text-6xl font-headline font-bold">{bigFish?.size || 0} <span className="text-lg font-normal text-slate-500">CM</span></p>
                        </div>
                        <div className="bg-white/5 backdrop-blur-xl p-8 rounded-[2rem] border border-white/10">
                           <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4">SCORE</p>
                           <p className="text-6xl font-headline font-bold text-yellow-400">{bigFish?.points || 0} <span className="text-lg font-normal text-slate-500">PTS</span></p>
                        </div>
                     </div>
                  </div>
               </div>
           ...
           <Card className="border-none shadow-xl rounded-[3rem] overflow-hidden bg-white">
              <CardHeader className="p-10 bg-slate-50 border-b border-slate-100 flex flex-row items-center justify-between space-y-0">
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                     <CardTitle className="text-xs font-bold text-slate-600 uppercase tracking-[0.2em]">Classement Général</CardTitle>
                     <CardDescription className="text-[10px] font-bold uppercase mt-1">Performances de la Rade</CardDescription>
                   </div>
                 </div>
                 <Badge variant="outline" className="text-slate-400 border-slate-200 font-bold px-4">{users?.length || 0} MEMBRES</Badge>
              </CardHeader>
              <CardContent className="p-0">
                <div className="divide-y divide-slate-50">
                   {users?.map((user, idx) => (
                     <div key={user.id} className="flex items-center justify-between p-10 hover:bg-slate-50/50 transition-colors group">
                        ...
                        <div className="flex items-center gap-16">
                           ...
                           <div className="text-right min-w-[120px]">
                              <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest mb-1">SCORE</p>
