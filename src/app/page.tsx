    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 md:py-40 overflow-hidden bg-primary text-white">
          <div className="container mx-auto px-4 relative z-20">
            <div className="max-w-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Button asChild size="lg" variant="secondary" className="font-headline font-bold h-14 px-8 text-lg rounded-full text-primary hover:bg-white transition-colors">
                  <Link href="/concours">
                    Saisir une Prise <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="bg-transparent text-white border-white/40 hover:bg-white hover:text-primary font-headline font-bold h-14 px-8 text-lg rounded-full backdrop-blur-sm transition-all">
          ...
          {/* Overlay color to match the initial vibrant blue with transparency */}
